...
export const translations = {
  en: {
    ...
    reviews: {
      ...
      titleAccent: "What Remains",
      items: [
        {
          quote: undefined,
          quotePrefix: "I learned that",
          quoteLead: undefined,
          quoteHighlight: "virtue is not innate.",
          quoteSuffix:
            " Human qualities are developed through practice—a muscle trained day after day.",
        ...
        },
        {
          ...
          quotePrefix: "I learned that",
          quoteLead: undefined,
          quoteHighlight: "our purpose is to be human:",
          quoteSuffix:
            " to leave every environment better than we found it, and to always be a constructive force.",
          quoteBreakAfterHighlight: true,
          author: "João",
          role: "Operations Director · Public Sector Enterprise",
        },
        {
          quote: undefined,
          quotePrefix: "I learned that",
          quoteLead: undefined,
          quoteHighlight: "happiness is always a choice:",
          quoteSuffix:
            " choosing to act with integrity, commitment, and responsibility, regardless of the circumstances.",
          quoteBreakAfterHighlight: true,
          author: "Eduardo",
          role: "Team Leader · Tech Multinational",
        },
      ],
    },
    partners: {
  ...
  pt: {
    ...
    hero: {
      ...
      titleLine1: "FILOSOFIA APLICADA ÀS",
      titleLine1Line2: "ORGANIZAÇÕES",
      titleLine2: "A coragem de parar.",
      titlePrefix: undefined,
      titleRotatingWords: undefined,
      description:
